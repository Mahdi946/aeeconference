(function($) {
	...
	jQuery(document).on('ready', function() {
		...
		$('.home-sliders').owlCarousel({
			...
			navText: ["<i class='flaticon-left'></i>", "<i class='flaticon-right-1'></i>", ],
		});
		...
		function makeTimer() {
			...
			$("#hour").html(hours + "<span>ساعت</span>");
			$("#minu").html(minutes + "<span>دقیقه</span>");
			$("#seco").html(seconds + "<span>ثانیه</span>");
		}
