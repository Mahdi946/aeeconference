                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-contact-box h-100">
                        ...
                        <div class="content-title">
                            <h3>موقعیت</h3>
                            <p>ایران ، تهران، خیابان ۱۶ شهید فرشی مقدم، پارک علم وفناوری دانشگاه تهران، ساختمان شماره یک،
                                دبیرخانه جایزه یونسکو.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                <div class="contact-image">
                                    <img src="{{ asset('assets-rtl/img/contact.png') }}" alt="image">
                                </div>
                            </div>
                        </div>
                    </div>
