                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-contact-box h-100">
                        ...
                        <div class="content-title">
                            <h3>Address</h3>
                            <p>Iran Secretariat of the UNESCO Prize, Science and Technology Park of the University of
                                Tehran, Farshi Moghadam, North Kargar, Tehran, Iran</p>
                        </div>
                    </div>
                </div>
                            ...
                            <form id="contactForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="message" class="form-control" id="message" cols="30" rows="6" required
                                        data-error="Please enter your Comments and suggestions" placeholder="Comments and suggestions"></textarea>
                                    <div class="help-block with-errors"></div>
                                </div>
